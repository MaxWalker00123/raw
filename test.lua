...
local check = loadAndEquipItem("Saber")
if not check then
    spawn(function()
        while wait(.2) do
    ...
    _G.MainSettings = {
            ...
            ["LockFragments"] = 150000, -- ล็อคเงินม่วง
    ...
    _G.Fruits_Settings = { -- ตั้งค่าผล
        ...
        ['Select_Fruits'] = {"Ice-Ice","Light-Light", "Dark-Dark","Rumble-Rumble", "Magma-Magma", "Buddha-Buddha", "Sound-Sound"} -- กินหรือซื้อตอนไม่มีผล
    }
    ...
    getgenv().Key = "MARU-2FMMQ-D6M0-5POLG-20A6-UZ462"
    getgenv().id = "1020342220785721354"
